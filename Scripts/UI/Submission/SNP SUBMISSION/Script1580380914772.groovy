...
WebUI.click(findTestObject('Object Repository/Page_SNP PORTAL/div_fiber_new CREATE A LONGEVITY RUN  20 Saved'))
...
WebUI.click(findTestObject('Page_SNP PORTAL/div_Measure Learning and Delete Rate of INE_85103b'))
...
WebUI.setText(findTestObject('Page_SNP PORTAL/input_Longevity Submission Name_ivu-input'), 'prerak_test11')

WebUI.setText(findTestObject('Page_SNP PORTAL/input_LRM Domain Name to Deploy_ivu-input'), 'rbu-snp-smoke')

WebUI.click(findTestObject('Page_SNP PORTAL/input_Longevity Submission Name_ivu-input'))

WebUI.click(findTestObject('Page_SNP PORTAL/button_Schedule job'))

WebUI.click(findTestObject('Object Repository/Page_SNP PORTAL/div_GO TO HOME TO SEE PROGRESS'))
