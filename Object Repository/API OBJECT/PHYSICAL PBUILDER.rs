...
<WebServiceRequestEntity>
   ...
   <name>PHYSICAL PBUILDER</name>
   <tag></tag>
   <elementGuidId>bd674777-cc9b-422a-aaf9-87a3d779a6b3</elementGuidId>
   ...
   <restUrl>https://scale.juniper.net/api/physicalpbuilder?params_path=${params_path}&amp;domain=${domain}&amp;topology_id=${topology_id}&amp;user=${user}&amp;longevity_submission_id=${longevity_submission_id}</restUrl>
